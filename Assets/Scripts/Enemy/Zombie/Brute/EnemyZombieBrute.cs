...
namespace ViralVial.Enemy.Zombie.Brute
{
    public class EnemyZombieBrute : MonoBehaviour, IEnemy, IDamageable, ITimeFreezable, IMindControllable, IShockWaveable
    {
