...
namespace ViralVial.Enemy.Zombie.Grunt
{
    public class EnemyZombieGrunt : MonoBehaviour, IEnemy, IDamageable, ITimeFreezable, IMindControllable, IShockWaveable
    {
