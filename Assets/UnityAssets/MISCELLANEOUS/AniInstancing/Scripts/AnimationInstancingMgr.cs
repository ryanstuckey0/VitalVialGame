...
namespace AnimationInstancing
{
    ...
    public class AnimationInstancingMgr : Singleton<AnimationInstancingMgr>
    {
        ...
        {
            EventManager.Instance.UnsubscribeFromEvent("UnloadGameContent", OnUnloadGameContent);
            Destroy(gameObject);
        }
        ...
        void ApplyBoneMatrix()
        {
            ...
            for (int i = 0; i != aniInstancingList.Count; ++i)
            {
                ...
                if (instance == null || instance?.transform == null) continue; // README: I think this will fix null ref exceptions. Not ideal since we don't know the root of the problem.
