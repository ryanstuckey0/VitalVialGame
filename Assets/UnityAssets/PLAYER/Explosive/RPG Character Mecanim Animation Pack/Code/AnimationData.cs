...
namespace RPGCharacterAnims
{
    ...
    public class AnimationData
    {
        ...
        public static bool IsRightWeapon(int weaponNumber)
        {
            ...
            return weaponNumber == (int)Weapon.Pistol;
        }
        ...
        public static bool Is2HandedWeapon(int weaponNumber)
        {
            ...
            //weaponNumber 20 = Shotgun
            //weaponNumber 21 = SMG
            return weaponNumber == (int)Weapon.Rifle
                || weaponNumber == (int)Weapon.Shotgun
                || weaponNumber == (int)Weapon.SMG;
        }
