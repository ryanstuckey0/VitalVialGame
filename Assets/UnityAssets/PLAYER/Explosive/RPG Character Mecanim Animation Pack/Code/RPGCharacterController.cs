...
namespace RPGCharacterAnims
{
    ...
    public class RPGCharacterController : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            animator.SetInteger("GunTo", 0);
            animator.SetInteger("GunFrom", 0);
            ...
            SetHandler("Relax", new Actions.Relax());
		...
		public void EndCrawl()
		{
			...
			SetAnimatorTrigger(AnimatorTrigger.CrawlTrigger);
			if (ikHands) {
				ikHands.BlendIK(true, 1, 0.5f, animator.GetInteger("GunTo"));
			}
		}
        ...
        public void AnimatorDebug()
        {
			...
			Debug.Log("Weapon: " + animator.GetInteger("GunTo"));
            Debug.Log("WeaponSwitch: " + animator.GetInteger("GunFrom"));
