...
namespace RPGCharacterAnims
{
    public class RPGCharacterWeaponController : MonoBehaviour
    {
        ...
        public IEnumerator _HideAllWeapons(bool timed, bool resetToUnarmed)
        {
            ...
            SafeSetVisibility(pistol, false);
            SafeSetVisibility(rifle, false);
            SafeSetVisibility(shotgun, false);
            SafeSetVisibility(smg, false);
        }
        ...
        public IEnumerator _WeaponVisibility(int weaponNumber, bool visible, bool dual)
        {
            ...
            if (weaponNumber == 17) { SafeSetVisibility(pistol, visible); } // pistol
            if (weaponNumber == 18) { SafeSetVisibility(rifle, visible); } // rifle
            if (weaponNumber == 20) { SafeSetVisibility(shotgun, visible); } // shotgun
            if (weaponNumber == 21) { SafeSetVisibility(smg, visible); } // smg
            yield return null;
        }
        ...
        private IEnumerator _SyncWeaponVisibility()
        {
            ...
            {
                case (int)Weapon.Pistol: SafeSetVisibility(pistol, true); break;
                case (int)Weapon.Rifle: SafeSetVisibility(rifle, true); break;
                case (int)Weapon.Shotgun: SafeSetVisibility(shotgun, true); break;
                case (int)Weapon.SMG: SafeSetVisibility(smg, true); break;
            }
        }
    }
}