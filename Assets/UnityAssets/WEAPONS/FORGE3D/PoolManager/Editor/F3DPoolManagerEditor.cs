...
public class F3DPoolManagerEditor : Editor
{
    ...
    public Dictionary<string, F3DPoolContainer> poolsDict = new Dictionary<string, F3DPoolContainer>();
    ...
    private string assetPath = "Assets/UnityAssets/WEAPONS/FORGE3D/Resources/F3DPoolManagerCache/";
