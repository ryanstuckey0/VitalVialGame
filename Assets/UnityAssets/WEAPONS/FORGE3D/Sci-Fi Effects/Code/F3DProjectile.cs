        ...
        void Update()
        {
            ...
            if (isHit)
            {
                ...
                if (!isFXSpawned)
                {
                    ...
                    BulletImpactSpawner.SpawnBulletImpact(hitPoint);
                    hitPoint.transform?.gameObject?.GetComponent<HitBox>()?.OnWeaponHit(WeaponUtilities.TurretDamagePerShot * WeaponUtilities.TurretDamageMultiplier);
