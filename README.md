...
- Agile Methodology & Jira- We used a Jira board to track all issues and bugs in the project based on two week sprints; we also locked the main branch and required multiple team members to approve their PR before they could merge to the main branch.
